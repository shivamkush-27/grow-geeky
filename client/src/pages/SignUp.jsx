...
const SignUp = () => {
  return (
    <div>
      <div className="flex flex-wrap text-slate-800 sm:px-10 md:px-4 w-full px-5 my-6 mx-auto lg:max-w-7xl">
        <div className="relative hidden pl-4 pr-8 mt-12 select-none flex-col justify-center md:flex md:w-[45%]">
        ...
        <div className="flex w-full flex-col md:w-[55%]">
          ...
          <div className="flex flex-col justify-center px-2 pt-4 md:px-6 md:pt-8 md:justify-start lg:w-full">
            ...
            <form className="flex flex-col items-stretch pt-3 md:pt-8">
              <div className="grid gap-3 md:grid-cols-2">
                <div className='relative'>
                  ...
                  <label for="text" className="absolute top-2 left-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform cursor-text select-none bg-white px-1 text-sm text-black duration-300 peer-placeholder-shown:top-[30%] peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-[#5459E8]"> First Name </label>
                </div>
                <div className='relative'>
                  <input type="text" id="lname" className="border-1 peer block w-full appearance-none rounded-lg border border-[#79747E] bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-black focus:border-[#5459E8] focus:outline-none focus:ring-0" />
                  <label for="text" className="absolute top-2 left-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform cursor-text select-none bg-white px-1 text-sm text-black duration-300 peer-placeholder-shown:top-[30%] peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-[#5459E8]"> Last Name </label>
                </div>
              </div>
              <div className="grid gap-3 md:grid-cols-2 pt-5">
                <div className='relative'>
                ...
                <div className='relative'>
                  <input type="tel" id="pnumber" className="border-1 peer block w-full appearance-none rounded-lg border border-[#79747E] bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-black focus:border-[#5459E8] focus:outline-none focus:ring-0" />
                  <label for="number" className="absolute top-2 left-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform cursor-text select-none bg-white px-1 text-sm text-black duration-300 peer-placeholder-shown:top-[30%] peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-[#5459E8]"> Phone Number </label>
                </div>
              </div>
              ...
              <div className="mb-4 flex flex-col pt-4">
                <div className="relative">
                  <input type="password" id="confirm-password" className="border-1 peer block w-full appearance-none rounded-lg border border-[#79747E] bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-black focus:border-[#5459E8] focus:outline-none focus:ring-0" />
              ...
              <p className="my-2 text-center text-sm font-medium text-gray-900">Already have an account? <a href="" className="text-[#ff8682]">Login</a></p>
            </form>
            ...
            <div className='my-10'>
              <div class="grid grid-cols-3 gap-3">
                <button type="button" class="transition duration-200 border border-[#515DEF] w-full py-2 md:py-4 px-8 rounded text-sm shadow-sm hover:shadow-md font-normal text-center flex justify-center">
